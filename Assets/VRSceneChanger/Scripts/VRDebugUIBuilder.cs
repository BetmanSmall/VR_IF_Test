...
public class VRDebugUIBuilder : MonoBehaviour {
    [SerializeField] private RectTransform buttonPrefab = null;
    [SerializeField] private RectTransform[] additionalButtonPrefab = null;
    [SerializeField] private RectTransform labelPrefab = null;
    [SerializeField] private RectTransform sliderPrefab = null;
    [SerializeField] private RectTransform dividerPrefab = null;
    [SerializeField] private RectTransform togglePrefab = null;
    [SerializeField] private RectTransform radioPrefab = null;
    [SerializeField] private RectTransform textPrefab = null;
    // [SerializeField] private GameObject uiHelpersToInstantiate = null;
    [SerializeField] private Transform[] targetContentPanels = null;
    private bool[] reEnable;
    [SerializeField] private List<GameObject> toEnable = null;
    [SerializeField] private List<GameObject> toDisable = null;
    public static VRDebugUIBuilder instance;
...
// #endif
    ...
    private void AddRect(RectTransform r, int targetCanvas) {
        if (targetCanvas > targetContentPanels.Length) {
            Debug.LogError("Attempted to add debug panel to canvas " + targetCanvas + ", but only " + targetContentPanels.Length +
    ...
    public RectTransform AddButton(string label, OnClick handler = null, int buttonIndex = -1, int targetCanvas = 0, bool highResolutionText = true) {
    ...
    public RectTransform AddLabel(string label, int targetCanvas = 0) {
        ...
        rt.GetComponentInChildren<TMP_Text>().text = label;
